...
void Shotgun::initShotgunAutomaticaly(SDL_Renderer* pRenderer, SDL_FRect pCharRect)
{
	...
	Weapon::setPaths(std::filesystem::current_path() / "Assets" / "photos and ttf" / "Shotgun.png",
					 std::filesystem::current_path() / "Assets" / "photos and ttf" / "brokenShotgun.png");
	Weapon::setShootPath(std::filesystem::current_path() / "Assets" / "photos and ttf" / "shootShotgun.png",
						{ {SideOfChar::RIGHT, {0,1,2}} }, 50, 100);
	Weapon::setReloadPath(std::filesystem::current_path() / "Assets" / "photos and ttf" / "reloadShotgun.png",
