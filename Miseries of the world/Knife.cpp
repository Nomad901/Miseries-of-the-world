...
void Knife::initKnifeAutomatically(SDL_Renderer* pRenderer, SDL_FRect pCharRect)
{
	initKnife(pRenderer, 
			  ...
			  pCharRect);
	Weapon::setPaths(std::filesystem::current_path() / "Assets" / "photos and ttf" / "knife.png",
					 std::filesystem::current_path() / "Assets" / "photos and ttf" / "brokenKnife.png");
	Weapon::setShootPath(std::filesystem::current_path() / "Assets" / "photos and ttf" / "knifeHitting.png", 
